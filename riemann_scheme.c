...
*	curva.
* AUTORES:
* - Santiago Hernandez Arias 1631281
* - Alejandro Palacios Hurtado 1630531
* LAST REVISED: 17/05/18
...
void* calcular(void *arg) {
	...
	// 2
	double loslimit = (double)(length/MAXTHREAD)*id;

	// 3
	partialSums[id]=0;

	// 4
	for (double i=0; i<numRectxThread; i++) {
		// 5
		double x = i*base_length + loslimit;
...
int main(int argc, char** argv) {
	...
	pthread_t threads[MAXTHREAD]; // almacena 'id' de hilos
